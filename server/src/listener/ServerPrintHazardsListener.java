...
public class ServerPrintHazardsListener implements Listener<PrintHazardsEvent> {
    ...
    public ServerPrintHazardsListener(ObjectOutputStream objectOut) {
        this.protocol = Protocol.TCP;
        this.objectOut = objectOut;
    }

    public ServerPrintHazardsListener(ObjectOutputStream objectOut, ByteArrayOutputStream byteArrayOut, DatagramSocket datagramSocket, InetAddress iAdress, int port) {
