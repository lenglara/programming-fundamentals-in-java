...
public class MainSimTwo {
        ...
        public static void main(String[] args) {
            ...
            Thread[] threadsToCreate = new Thread[num];
            Thread[] threadsToDelete = new Thread[num];

            for (int i = 0; i < num; i++) {
                threadsToCreate[i] = new Thread(rc);
                threadsToCreate[i].start();
                threadsToDelete[i] = new Thread(rd);
                threadsToDelete[i].start();
            }
        }
}
