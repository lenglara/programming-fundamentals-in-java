...
public class ClientLoadListener implements Listener<PersistenceEvent> {
    ...
    public ClientLoadListener(ObjectOutputStream objectOut, DataOutputStream dataOut) {
            this.protocol = Protocol.TCP;
            this.objectOut = objectOut;
            this.dataOut = dataOut;
        }

    public ClientLoadListener(DatagramSocket datagramSocket, InetAddress address, int port) {
